...
- **Smoothing Splines:** I conduct research on smoothing spline ANOVA models, concentrating on (1) developing models for survival data and (2) exploring statistical inference, including effect-wise hypothesis testing.  
...
- **Survival Analysis:** I focus on the accurate computation of partial likelihood, including computational, methodological, and theoretical development, with a emphasis on its application to heavily tied data.
